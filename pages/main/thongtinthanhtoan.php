  ...
  ?>
	...
	<div class="row">
 	...
 	?>
  	...
  	<div class="col-md-8 vanchuyen">
  		<h4>Thông tin vận chuyển và giỏ hàng</h4>
  		<ul>
  			<li style="list-style-type: none;">Họ và tên vận chuyển : <b><?php echo $name ?></b></li>
  			<li style="list-style-type: none;">Số điện thoại : <b><?php echo $phone ?></b></li>
  			<li style="list-style-type: none;">Địa chỉ : <b><?php echo $address ?></b></li>
  			<li style="list-style-type: none;">Ghi chú : <b><?php echo $note ?></b></li>
  		</ul>
  		<h5>Giỏ hàng của bạn</h5>
  		<table class="gio_hang" style="width:100%;text-align: center;border-collapse: collapse;" border="1">
		  <tr>
		    <th>Id</th>
		    <th>Mã sp</th>
		    <th>Tên sản phẩm</th>
  	...
  	<div class="col-md-4 hinhthucthanhtoan">
		...
		<div class="form-check">
		  ...
		  <img src="images/vnpay.png" height="20" width="64" style = "margin-left:20px;">
